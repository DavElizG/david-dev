      ...
      gsap.timeline({
        onComplete: () => {
          ...
          gsap.timeline()
            ...
            // Radial reveal: transparent hole grows from center outward
            .add(() => {
              const radius = { r: 0 };
              gsap.to(radius, {
                r: 220,
                ...
                onUpdate: () => {
                  if (overlayRef.current) {
                    overlayRef.current.style.background =
                      `radial-gradient(circle ${radius.r}vmax at 50% 50%, transparent 99%, #000 100%)`;
                  }
                },
                onComplete: () => {
        ...
        // Entrance: corners + content fade in
        .fromTo(corners,
